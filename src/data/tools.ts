...
export const tools: Tool[] = [
  ...
  { id: "114", name: "Merge PDFs", category: "File Converters & Editors", description: "Merge multiple PDF files", slug: "merge-pdfs", keywords: ["merge", "pdf", "combine"] },
  ...
  { id: "121", name: "Word to PDF", category: "File Converters & Editors", description: "Convert Word documents to PDF", slug: "word-to-pdf", keywords: ["word", "pdf", "convert"] },
  ...
  { id: "137", name: "Image Compressor", category: "File Converters & Editors", description: "Compress images online", slug: "image-compressor", keywords: ["image", "compress", "size"] },
  { id: "138", name: "Image Resizer", category: "File Converters & Editors", description: "Resize images online", slug: "image-resizer", keywords: ["image", "resize", "size"] },
  { id: "139", name: "Image Cropper", category: "File Converters & Editors", description: "Crop images online", slug: "image-cropper", keywords: ["image", "crop", "edit"] },
  { id: "140", name: "Image Converter", category: "File Converters & Editors", description: "Convert image formats", slug: "image-converter", keywords: ["image", "convert", "format"] },
  { id: "141", name: "Image to Base64", category: "File Converters & Editors", description: "Convert image to Base64", slug: "image-to-base64", keywords: ["image", "base64", "convert"] },
  { id: "142", name: "Base64 to Image", category: "File Converters & Editors", description: "Convert Base64 to image", slug: "base64-to-image", keywords: ["base64", "image", "convert"] },
  { id: "143", name: "Add Text to Image", category: "File Converters & Editors", description: "Add text overlay to images", slug: "add-text-to-image", keywords: ["text", "image", "overlay"] },
  ...
  { id: "146", name: "SVG to PNG", category: "File Converters & Editors", description: "Convert SVG to PNG", slug: "svg-to-png", keywords: ["svg", "png", "convert"] },
  ...
  { id: "163", name: "JPG to PNG", category: "File Converters & Editors", description: "Convert JPG to PNG", slug: "jpg-to-png", keywords: ["jpg", "png", "convert"] },
